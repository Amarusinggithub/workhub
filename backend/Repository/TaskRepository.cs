...
using ApplicationTask = backend.Models.Task;

namespace backend.Repository.interfaces;

public class TaskRepository: GenericRepository<ApplicationTask>,ITaskRepository
{
    public TaskRepository(ApplicationDbContext context, ILogger logger) : base(context, logger)
    {
    }

    public override async Task<IEnumerable<ApplicationTask>> GetAll()
    {
        try
        {
    ...
    public override async Task<bool> Upsert(ApplicationTask entity)
    {
        try
        {
